...
public class LOF {
	...
	public static void main(String[] args){
		...
		data.add(new double[]{390, 60});
		data.add(new double[]{450, 30});
		data.add(new double[]{420, 90});
		data.add(new double[]{480, 60});
		data.add(new double[]{100, 250});
		data.add(new double[]{50, 300});
		data.add(new double[]{170, 300});
		data.add(new double[]{110, 400});
		data.add(new double[]{75, 450});
		data.add(new double[]{180, 430});
		data.add(new double[]{250, 370});
		data.add(new double[]{400, 240});
